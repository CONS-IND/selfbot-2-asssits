...
Bots = [gyeMID,aisMID,ki2MID] #ini jangan dinrubah Gunanya agar bot tidak saling kick
creator = ["u4d4b6b57a29acd07e27b5b0f31a2e64e"]
Owner = ["u4d4b6b57a29acd07e27b5b0f31a2e64e"]
admin = ["u4d4b6b57a29acd07e27b5b0f31a2e64e"]
...
#==============================================================================#
                    ...
                    ais.leaveGroup(msg.to)
                    ki2.leaveGroup(msg.to)
                elif text.lower() in ["join warbot"]:    
